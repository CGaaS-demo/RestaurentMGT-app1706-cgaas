...
// @Summary      DownloadCustomer 
// @Description   This API performs the DOWNLOAD operation on Customer. It allows you to  Customer records.
// @Tags          Customer
// @Accept       json
// @Produce      json
...
// @Router      /DownloadCustomer [DOWNLOAD]

    func DownloadCustomerApi(c *fiber.Ctx) error {


    objects, err := dao.DB_FindallCustomer ()
	if err != nil {
		return err
	}
	...
	fileName := "Customers" + time.Now().Format("2006-01-02") + ".csv"

...
// @Summary      DownloadRestaurent 
// @Description   This API performs the DOWNLOAD operation on Restaurent. It allows you to  Restaurent records.
// @Tags          Restaurent
// @Accept       json
// @Produce      json
...
// @Router      /DownloadRestaurent [DOWNLOAD]

    func DownloadRestaurentApi(c *fiber.Ctx) error {


    objects, err := dao.DB_FindallRestaurent ()
	if err != nil {
		return err
	}
	...
	fileName := "Restaurents" + time.Now().Format("2006-01-02") + ".csv"
